...
public final class CosmicLauncher {
	...
	private static final String PROJECT_HOME = "C:/Users/shownyoung/kingdee/cosmic";
...
//			logConfigXmlContent = new String(getClass().getClassLoader().getResourceAsStream(path),Charset.forName("utf-8") );
